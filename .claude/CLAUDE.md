...
**REGRA OBRIGATÓRIA:** Após executar qualquer task ou workflow, todo agent DEVE seguir o Post-Execution Protocol.

**Documento completo:** `.aiox-core/core/execution/POST-EXECUTION-PROTOCOL.md`

### 3 Etapas obrigatórias após cada comando:
